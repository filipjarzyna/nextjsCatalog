  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mx-auto max-md:px-2'>
      <div className='h-full max-lg:mx-auto'>
        <img className='rounded-2xl max-h-[600px] object-cover max-lg:mx-auto lg:ml-auto' src={`${imagesPath}/${product.image}`} />
      </div>
      <div className='mx-auto w-full max-w-xl'>
        <div className='flex flex-col mb-6 h-full justify-between'>
          <div className='text-wrap overflow-hidden'>
            <h2 className='font-bold text-3xl leading-10 mb-1'>
              {product.name}
            </h2>
            ...
            <div>
              <div className='flex gap-6 flex-col text-xl'>
                ...
                <div>
                  ...
                  <Link href={{pathname: `/sklep`, query: {category: product.category}}} className='link-red'>
                    {product.category}
                  </Link>
                </div>
              </div>
          ...
          <div className='text-xl mb-2'>
            <p className='text-red-400 text-2xl pt-8'>Uwaga</p>
